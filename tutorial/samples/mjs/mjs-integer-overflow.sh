...
PATCH="patch-d6c06a6-integer-overflow-for-fuzz"
...
if [ "$1" != "-" ] ; then
	...
	mkdir $TMP_DIR
	#Testing for issue 57
	#https://github.com/cesanta/mjs/issues/57
	[ ! -d mjs ] && git clone https://github.com/cesanta/mjs && cd mjs && git checkout d6c06a6 && cd ..
	
	#setup targets
	cd mjs && git checkout mjs.c && git checkout d6c06a6 && patch -p1 mjs.c < $DOWNLOAD_DIR/../$PATCH && cd -
	echo -e "mjs.c:13784\nmjs.c:13977" >$TMP_DIR/BBtargets.txt
