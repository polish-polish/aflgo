...
#PATCH="patch-8d847f2-use-after-free-for-fuzz"
...
if [ "$1" != "-" ] ; then
	...
	#fi
	#mkdir $TMP_DIR
	#Testing for issue #114
	#https://github.com/cesanta/mjs/issues/114
	[ ! -d mjs ] && git clone https://github.com/cesanta/mjs && cd mjs && git checkout 8d847f2 && cd ..
	
	#setup targets
	cd ./mjs && git checkout mjs.c && git checkout 8d847f2 && cd - 

	echo -e "mjs.c:9644\nmjs.c:9681\nmjs.c:9831\nmjs.c:10212\nmjs.c:10235\nmjs.c:12607" >$TMP_DIR/BBtargets.txt
	...
	#cd mjs && $CC ./mjs.c -fsanitize=address -DMJS_MAIN $CFLAGS -ldl -g -o mjs/$TARGET && cd -
